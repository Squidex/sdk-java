...
public final class BulkUpdateAssetsJobDto {
    ...
    public String toString() {
        return "BulkUpdateAssetsJobDto{" + "id: " + id + ", type: " + type + ", parentId: " + parentId + ", fileName: "
                + fileName + ", slug: " + slug + ", isProtected: " + isProtected + ", tags: " + tags + ", metadata: "
                + metadata + ", permanent: " + permanent + ", expectedVersion: " + expectedVersion + "}";
    }
