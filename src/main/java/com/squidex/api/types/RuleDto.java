...
public final class RuleDto implements IResource {
    ...
    public String toString() {
        return "RuleDto{" + "links: " + links + ", id: " + id + ", createdBy: " + createdBy + ", lastModifiedBy: "
                + lastModifiedBy + ", created: " + created + ", lastModified: " + lastModified + ", version: " + version
                + ", isEnabled: " + isEnabled + ", name: " + name + ", trigger: " + trigger + ", action: " + action
                + ", numSucceeded: " + numSucceeded + ", numFailed: " + numFailed + ", lastExecuted: " + lastExecuted
                + "}";
    }
