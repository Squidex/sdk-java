...
public final class RuleActionDto {
    ...
    public static RuleActionDto deepDetect(DeepDetectRuleActionDto value) {
        return new RuleActionDto(new DeepDetectValue(value));
    }
    ...
    public boolean isDeepDetect() {
        return value instanceof DeepDetectValue;
    }
    ...
    public Optional<DeepDetectRuleActionDto> getDeepDetect() {
        if (isDeepDetect()) {
            return Optional.of(((DeepDetectValue) value).value);
        }
        return Optional.empty();
    }
    ...
    public interface Visitor<T> {
        ...
        T visitDeepDetect(DeepDetectRuleActionDto deepDetect);
    ...
    @JsonSubTypes({
        ...
        @JsonSubTypes.Type(DeepDetectValue.class),
    ...
    @JsonTypeName("DeepDetect")
    private static final class DeepDetectValue implements Value {
        @JsonUnwrapped
        private DeepDetectRuleActionDto value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private DeepDetectValue() {}

        private DeepDetectValue(DeepDetectRuleActionDto value) {
            this.value = value;
        }

        @Override
        public <T> T visit(Visitor<T> visitor) {
            return visitor.visitDeepDetect(value);
        }

        @Override
        public boolean equals(Object other) {
            if (this == other) return true;
            return other instanceof DeepDetectValue && equalTo((DeepDetectValue) other);
        }

        private boolean equalTo(DeepDetectValue other) {
            return value.equals(other.value);
        }
