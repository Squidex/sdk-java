...
public final class TweetRuleActionDto {
    ...
    /**
     * @return The generated access secret.
     */
    ...
    /**
     * @return The text that is sent as tweet to twitter.
     */
    @JsonProperty("text")
    ...
    public static final class Builder implements AccessTokenStage, AccessSecretStage, TextStage, _FinalStage {
        ...
        /**
         * <p>The generated access secret.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @Override
        ...
        /**
         * <p>The text that is sent as tweet to twitter.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @Override
        @JsonSetter("text")
