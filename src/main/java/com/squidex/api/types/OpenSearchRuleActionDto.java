...
@JsonDeserialize(builder = OpenSearchRuleActionDto.Builder.class)
public final class OpenSearchRuleActionDto {
    ...
    private OpenSearchRuleActionDto(
            String host,
            String indexName,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OpenSearchRuleActionDto && equalTo((OpenSearchRuleActionDto) other);
    }

    private boolean equalTo(OpenSearchRuleActionDto other) {
    ...
    public String toString() {
        return "OpenSearchRuleActionDto{" + "host: " + host + ", indexName: " + indexName + ", username: " + username
    ...
    public interface HostStage {
        ...
        Builder from(OpenSearchRuleActionDto other);
    }
    ...
    public static final class Builder implements HostStage, IndexNameStage, _FinalStage {
        ...
        @Override
        public Builder from(OpenSearchRuleActionDto other) {
            host(other.getHost());
        ...
        @Override
        public OpenSearchRuleActionDto build() {
            return new OpenSearchRuleActionDto(host, indexName, username, password, document, delete);
        }
    }
}
