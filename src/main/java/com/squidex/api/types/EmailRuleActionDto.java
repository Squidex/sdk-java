...
public final class EmailRuleActionDto {
    ...
    public String toString() {
        return "EmailRuleActionDto{" + "serverHost: " + serverHost + ", serverPort: " + serverPort
                + ", serverUsername: " + serverUsername + ", serverPassword: " + serverPassword + ", messageFrom: "
                + messageFrom + ", messageTo: " + messageTo + ", messageSubject: " + messageSubject + ", messageBody: "
                + messageBody + "}";
    }
