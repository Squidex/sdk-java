...
public final class DiscourseRuleActionDto {
    ...
    /**
     * @return The url to the discourse server.
     */
    @JsonProperty("url")
    ...
    /**
     * @return The api key to authenticate to your discourse server.
     */
    @JsonProperty("apiKey")
    ...
    /**
     * @return The api username to authenticate to your discourse server.
     */
    ...
    public static final class Builder implements UrlStage, ApiKeyStage, ApiUsernameStage, TextStage, _FinalStage {
        ...
        /**
         * <p>The url to the discourse server.</p>
        ...
        /**
         * <p>The api key to authenticate to your discourse server.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @Override
        @JsonSetter("apiKey")
        ...
        /**
         * <p>The api username to authenticate to your discourse server.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @Override
