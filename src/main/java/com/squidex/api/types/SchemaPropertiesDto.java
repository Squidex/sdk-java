...
public final class SchemaPropertiesDto {
    ...
    public String toString() {
        return "SchemaPropertiesDto{" + "label: " + label + ", hints: " + hints + ", contentsSidebarUrl: "
                + contentsSidebarUrl + ", contentSidebarUrl: " + contentSidebarUrl + ", contentEditorUrl: "
                + contentEditorUrl + ", validateOnPublish: " + validateOnPublish + ", tags: " + tags + "}";
    }
