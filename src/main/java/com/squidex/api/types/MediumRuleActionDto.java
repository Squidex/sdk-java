...
public final class MediumRuleActionDto {
    ...
    /**
     * @return The self issued access token.
     */
    ...
    /**
     * @return The title, used for the url.
     */
    @JsonProperty("title")
    ...
    /**
     * @return The content, either html or markdown.
     */
    ...
    public static final class Builder implements AccessTokenStage, TitleStage, ContentStage, IsHtmlStage, _FinalStage {
        ...
        /**
         * <p>The self issued access token.</p>
        ...
        /**
         * <p>The title, used for the url.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @Override
        @JsonSetter("title")
        ...
        /**
         * <p>The content, either html or markdown.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @Override
        @JsonSetter("content")
