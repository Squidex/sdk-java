...
@JsonDeserialize(builder = ContentsGetReferencingRequest.Builder.class)
public final class ContentsGetReferencingRequest {
    ...
    private ContentsGetReferencingRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ContentsGetReferencingRequest && equalTo((ContentsGetReferencingRequest) other);
    }

    private boolean equalTo(ContentsGetReferencingRequest other) {
    ...
    public String toString() {
        return "ContentsGetReferencingRequest{" + "flatten: " + flatten + ", languages: " + languages
                + ", unpublished: " + unpublished + ", noSlowTotal: " + noSlowTotal + ", noTotal: " + noTotal + ", q: "
                + q + "}";
    }
    ...
    public static final class Builder {
        ...
        public Builder from(ContentsGetReferencingRequest other) {
        ...
        public ContentsGetReferencingRequest build() {
            return new ContentsGetReferencingRequest(flatten, languages, unpublished, noSlowTotal, noTotal, q);
        }
    }
}
