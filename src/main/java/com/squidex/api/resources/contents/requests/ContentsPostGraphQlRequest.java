...
@JsonDeserialize(builder = ContentsPostGraphQlRequest.Builder.class)
public final class ContentsPostGraphQlRequest {
    private final Optional<Boolean> unpublished;

    private final Object body;

    private ContentsPostGraphQlRequest(Optional<Boolean> unpublished, Object body) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ContentsPostGraphQlRequest && equalTo((ContentsPostGraphQlRequest) other);
    }

    private boolean equalTo(ContentsPostGraphQlRequest other) {
    ...
    public interface _FinalStage {
        ContentsPostGraphQlRequest build();
    ...
    public static final class Builder implements BodyStage, _FinalStage {
        ...
        @Override
        public Builder from(ContentsPostGraphQlRequest other) {
        ...
        @Override
        public ContentsPostGraphQlRequest build() {
            return new ContentsPostGraphQlRequest(unpublished, body);
        }
    }
}
