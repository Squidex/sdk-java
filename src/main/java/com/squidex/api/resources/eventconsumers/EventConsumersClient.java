    ...
    public EventConsumersDto getEventConsumers(RequestOptions requestOptions) {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), EventConsumersDto.class);
            }
            throw new ApiError(
                    response.code(),
    ...
    public EventConsumerDto startEventConsumer(String consumerName, RequestOptions requestOptions) {
        ...
        try {
            Response response =
                    clientOptions.httpClient().newCall(okhttpRequest).execute();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(response.body().string(), EventConsumerDto.class);
            }
            throw new ApiError(
                    response.code(),
                    ObjectMappers.JSON_MAPPER.readValue(response.body().string(), Object.class));
