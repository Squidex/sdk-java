...
@JsonDeserialize(builder = AssetsGetAssetContentRequest.Builder.class)
public final class AssetsGetAssetContentRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AssetsGetAssetContentRequest && equalTo((AssetsGetAssetContentRequest) other);
    }

    private boolean equalTo(AssetsGetAssetContentRequest other) {
    ...
    public String toString() {
        return "AssetsGetAssetContentRequest{" + "version: " + version + ", cache: " + cache + ", download: " + download
                + ", width: " + width + ", height: " + height + ", quality: " + quality + ", mode: " + mode + ", bg: "
                + bg + ", focusX: " + focusX + ", focusY: " + focusY + ", nofocus: " + nofocus + ", auto: " + auto
                + ", force: " + force + ", format: " + format + "}";
    }
    ...
    public static final class Builder {
        ...
        public Builder from(AssetsGetAssetContentRequest other) {
