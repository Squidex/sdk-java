...
import com.squidex.api.core.auth.Authentication;
import com.squidex.api.core.auth.HttpBasicAuth;
import com.squidex.api.core.auth.HttpBearerAuth;
import com.squidex.api.core.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://cloud.squidex.io";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloud.squidex.io
     ...
     * @return a {@link com.squidex.api.core.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.squidex.api.core.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.squidex.api.core.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.squidex.api.core.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.squidex.api.core.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.squidex.api.core.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.squidex.api.core.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.squidex.api.core.ApiException If fails to update the parameters
     */
     ...
     * @throws com.squidex.api.core.ApiException If fail to serialize the request body object into a string
     */
